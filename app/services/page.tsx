      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex flex-1 items-center justify-start space-x-8 font-semibold text-xs lg:text-sm text-[#335495]">
              <a href="/services" className="text-[#C8D653] transition tracking-widest">SERVICES</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t p-6 flex flex-col space-y-6 font-bold text-[#335495] shadow-2xl absolute w-full z-50">
            ...
            <a href="/about-us" className="hover:text-[#C8D653] border-b border-gray-100 pb-2">ABOUT US</a>
            <a href="/services" className="text-[#C8D653] border-b border-gray-100 pb-2">SERVICES</a>
